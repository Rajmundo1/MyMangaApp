...
interface MangaService {
    ...
    @GET("manga")
    suspend fun getManga(@Query("limit") limit: Int = 10, @Query("offset") offset: Int = 0, @Query("title") title: String? = null, @Header("Authorization") authHeader: String): ApiResponse<MangaList>
