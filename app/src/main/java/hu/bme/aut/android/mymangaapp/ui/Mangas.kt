...
import hu.bme.aut.android.mymangaapp.extensions.visible
...
import hu.bme.aut.android.mymangaapp.ui.main.MainViewModel
import hu.bme.aut.android.mymangaapp.ui.theme.purple200
...
fun Mangas(
    ...
    val mangas: List<Manga> by viewModel.mangaList.collectAsState(initial = listOf())
    ...
    ConstraintLayout {
        ...
        Scaffold(
            ...
            HomeMangas(modifier, mangas, selectManga)
        }
